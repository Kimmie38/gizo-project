  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="relative w-full md:w-1/2 flex flex-col justify-end items-center text-white p-6 md:p-8">
        ...
        {/* Overlay content */}
        <div className="relative z-10 text-center mt-20 md:mt-0 mb-8 md:mb-12 max-w-md px-4">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white">
        <div className="w-full max-w-md px-4 sm:px-6 md:px-8 py-12">
          ...
          <form className="space-y-4" onSubmit={handleNext}>
            ...
            <button
              type="submit"
              className="w-full mt-6 py-3 rounded-xl font-medium text-sm md:text-base bg-emerald-500 hover:bg-emerald-600 text-white transition"
            >
              Next
            </button>
          </form>
          ...
          {/* Google Signup */}
          <button className="w-full mt-4 flex items-center justify-center border border-gray-300 py-3 rounded-xl hover:bg-gray-50 transition text-sm md:text-base text-black">
            <Image
